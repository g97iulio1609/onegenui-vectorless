...
export {
  ...
  type AgenticRetrievalOptions,
  type Citation as AgenticCitation,
} from "./agentic-retrieval.js";
...
} from "./toc-verifier.js";

// Large node processing (from original PageIndex)
export {
  processLargeNode,
  processLargeNodesInTree,
  type LargeNodeOptions,
} from "./large-node-processor.js";
...
export {
  ...
  removeNodeText,
  getNodeText,
  addNodeTextWithProgress,
  validateNodePageRanges,
  addPrefaceIfNeeded,
} from "./node-text-extractor.js";
...
export function createExtendedAgents(
  model: LanguageModel,

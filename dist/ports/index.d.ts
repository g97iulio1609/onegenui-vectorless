import type { TreeNode, TocEntry, DocumentIndex, SSEEvent, KnowledgeNode, DocumentKnowledgeBase, Answer, Entity, Relation, Quote, Keyword, DocumentMetrics, Citation } from "../domain/schemas.js";
...
export interface StructureExtractorPort {
    extractStructure(pages: Page[], tocEntries: TocEntry[] | null, tocEndPage: number | null): AsyncGenerator<{
        event: SSEEvent;
        node?: TreeNode;
    }>;
}
export interface SummarizerPort {
    generateSummaries(tree: TreeNode, pages: Page[]): AsyncGenerator<{
        event: SSEEvent;
        nodeId?: string;
        summary?: string;
    }>;

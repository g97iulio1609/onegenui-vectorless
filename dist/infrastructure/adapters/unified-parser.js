...
export class UnifiedDocumentParser {
    pdfParser = new PdfParseAdapter();
    wordParser = new MammothAdapter();
    excelParser = new XlsxAdapter();
    markdownParser = new MarkdownAdapter();
    pptxParser = new PptxParserAdapter();

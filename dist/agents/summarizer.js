import { ToolLoopAgent, tool, stepCountIs, Output, NoObjectGeneratedError, } from "ai";
import { z } from "zod";
...
export function createSummarizerAgent(model) {
            ...
            for (const node of nodes) {
                ...
                try {
                    ...
                    if (NoObjectGeneratedError.isInstance(error)) {
                        console.error(`[summarizer] Schema validation failed for "${node.title}":`, {
